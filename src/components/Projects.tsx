...
const projects = [
  {
    title: "MySelf Pilot",
    description:
      "Full-stack middleware hub connecting autonomous vehicle taxi companies, logistics fleets, and city transport into a unified ecosystem for shared payments, tariffs, and vehicle access.",
    tags: [
      "Next.js",
      "React 19",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "Full-stack SaaS consortium platform for AXONS Alliance — an open standard for secure real-time IoT communication — with membership management, 8-language i18n, and Stripe subscription billing.",
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
