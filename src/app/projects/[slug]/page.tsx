...
function TechIcon({ category }: { category: string }) {
  ...
  return <div className="flex size-9 items-center justify-center rounded-lg bg-accent/10 text-accent">{icon}</div>;
}
            ...
            {project.techStack.map((cat) => (
              ...
              >
                <div className="mb-3 flex items-center gap-2.5">
                  <TechIcon category={cat.category} />
